...
class MainWindow(QMainWindow):
    ...
    def create_new_card(self):
        ...
        full_card_data = {"spec": "chara_card_v2", "spec_version": "2.0",
                          "data": {"name": card_info.get("name", ""), "description": card_info.get("description", ""),
                                   ...
                                   "tags": tags_list, "creator": card_info.get("creator", ""),
        ...
        if success:
            QMessageBox.information(self, "成功",
                                    f"角色卡 '{card_info.get('name')}' 已成功创建!")
